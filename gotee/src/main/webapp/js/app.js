...
function LoginController($scope, $rootScope, $location, $cookieStore, UserService) {
    ...
    $scope.login = function () {
    	...
    	/*  UserService.authenticate(logindata).success(function(response){
...
services.factory('UserService', function ($resource,$http,$location) {
   ...
   return $resource('rest/user/:action', {},
	...
	/*return {
		authenticate: function(loginData) {
	       $http.post("rest/user/authenticate",loginData).then(function(response) {
	        books = response.data;
